 ...
 * Acceder: https://honda.com.py/check-routes.php?token=honda2025check
 */
...
if (!isset($_GET['token']) || $_GET['token'] !== CHECK_TOKEN) {
    ...
    die('❌ Acceso denegado. Usar: ?token=' . CHECK_TOKEN);
}
...
<head>
    ...
    <title>Verificar Rutas - Honda Laravel</title>
    <style>
        body {
            ...
            <tbody>
                <?php foreach ($routes as $route): ?>
                    ...
                    <tr class="<?php echo $isHighlight ? 'highlight' : ''; ?>">
                        ...
                        <td style="font-size: 11px;"><?php echo htmlspecialchars($action); ?></td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
