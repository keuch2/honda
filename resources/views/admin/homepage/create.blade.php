...
@section('content')
    <div class="py-12">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-6">
                <h1 class="text-2xl font-semibold text-gray-900">Nuevo Slide del Hero</h1>
                <p class="text-sm text-gray-500">Subí una imagen para el carrusel principal del homepage.</p>
            </div>

            <div class="bg-white shadow-sm sm:rounded-lg">
                <form action="{{ route('admin.homepage.store') }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
                    @csrf
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-xs text-gray-500">JPG, PNG, WEBP. Máximo 5MB. Recomendado: 1920px de ancho o más.</p>
                    ...
                    <div>
                        ...
                        <input type="text" name="imagen_alt" id="imagen_alt" value="{{ old('imagen_alt') }}"
